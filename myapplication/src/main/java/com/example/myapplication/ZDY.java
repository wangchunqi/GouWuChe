...
public class ZDY extends LinearLayout implements View.OnClickListener, TextWatcher {
    ...
    public ZDY(Context context, AttributeSet attrs) {
        ...
        int btnWidth = obtainStyledAttributes.getDimensionPixelSize(R.styleable.AmountView_btnWidth, 30);
